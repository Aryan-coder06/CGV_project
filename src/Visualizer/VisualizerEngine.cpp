...
void VisualizerEngine::renderVisualizeTab() {
  ...
  if (isWinViewport) {
    ...
    ImGui::PopStyleColor();
    ImGui::SetNextItemWidth(100); ImGui::InputFloat("Wx min##wv", &inputWxMin, 1.f, 5.f, "%.1f");
    ImGui::SetNextItemWidth(100); ImGui::InputFloat("Wx max##wv", &inputWxMax, 1.f, 5.f, "%.1f");
    ImGui::SetNextItemWidth(100); ImGui::InputFloat("Wy min##wv", &inputWyMin, 1.f, 5.f, "%.1f");
    ImGui::SetNextItemWidth(100); ImGui::InputFloat("Wy max##wv", &inputWyMax, 1.f, 5.f, "%.1f");
    ...
    ImGui::PopStyleColor();
    ImGui::SetNextItemWidth(100); ImGui::InputFloat("Vx min##wv", &inputVxMin, 1.f, 5.f, "%.1f");
    ImGui::SetNextItemWidth(100); ImGui::InputFloat("Vx max##wv", &inputVxMax, 1.f, 5.f, "%.1f");
    ImGui::SetNextItemWidth(100); ImGui::InputFloat("Vy min##wv", &inputVyMin, 1.f, 5.f, "%.1f");
    ImGui::SetNextItemWidth(100); ImGui::InputFloat("Vy max##wv", &inputVyMax, 1.f, 5.f, "%.1f");
    ...
    ImGui::PopStyleColor();
    ImGui::SetNextItemWidth(100); ImGui::InputInt("CX##wv",    &inputWVCX);
    ImGui::SetNextItemWidth(100); ImGui::InputInt("CY##wv",    &inputWVCY);
    ImGui::SetNextItemWidth(100); ImGui::InputInt("Size##wv",  &inputWVSize);
    ImGui::SetNextItemWidth(100); ImGui::InputInt("Sides##wv", &inputWVSides);
