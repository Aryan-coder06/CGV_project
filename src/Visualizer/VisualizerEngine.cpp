...
void VisualizerEngine::renderUI() {
    ...
    ImGui::SetNextWindowSize(ImVec2(400, (float)ImGui::GetIO().DisplaySize.y), ImGuiCond_Always);
    ...
    auto catButton = [&](const char* label, Category cat, bool active) {
        ...
        if (ImGui::Button(label, ImVec2(tabW, 28))) {
    ...
    if (ImGui::BeginTabBar("##MainTabs")) {
        ...
        if (ImGui::BeginTabItem("  Visualize  ")) {
            ...
            ImGui::BeginChild("##StepLog", ImVec2(0, 100), false);
